...
import {ArrowRight, Check, Shield, Wrench, X, Zap} from 'lucide-react';
      ...
      <div
        ...
        <div className="max-w-6xl mx-auto w-full flex-grow">
          ...
          <div className="text-center mb-12">
            <h2
              className={`text-3xl font-bold ${darkMode ? 'text-white' : 'text-gray-900'} mb-4 transition-colors duration-300`}>Planes
              de Precios Flexibles</h2>
            <p
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center mb-4">
                    ...
                    <h3
                      className={`text-xl font-bold ${darkMode ? 'text-white' : 'text-gray-900'} transition-colors duration-300`}>{plan.name}</h3>
                  </div>

                  <p
                    className={`${darkMode ? 'text-gray-300' : 'text-gray-600'} text-sm mb-4 transition-colors duration-300`}>{plan.description}</p>
          ...
          <div className="text-center mt-12">
            ...
            <div
              ...
              <p className={`text-sm ${darkMode ? 'text-blue-200' : 'text-blue-800'} transition-colors duration-300`}>
                Todos los planes incluyen una prueba gratuita de 14 días. No se requiere tarjeta de crédito hasta que
                decida continuar.
              </p>
            </div>
          </div>
