...
const AboutSoftware = () => {
  ...
  return (
    <>
      ...
      >
        {/* Hero Section */}
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-20 -mx-4 sm:-mx-6 lg:-mx-8">
        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <StatCard number="98%" text="de satisfacción" darkMode={darkMode} />
            <StatCard number="50%" text="más eficiencia" darkMode={darkMode} />
            <StatCard
              number="1000+"
        ...
        {/* CTA Section */}
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-16 -mx-4 sm:-mx-6 lg:-mx-8">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-6">
              Comienza a Usar Nuestro Software Hoy
            </h2>
            <p className="text-xl mb-8">
              Únete a los cientos de talleres que ya han modernizado su gestión
            </p>
