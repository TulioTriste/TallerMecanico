...
import {Lock, LogIn, Mail, Wrench} from 'lucide-react';
...
export default function LoginForm() {
  ...
  return (
    <>
      <Navbar/>
      <div
        className={`w-full min-h-screen flex items-center justify-center py-16 px-4 sm:px-6 lg:px-8 transition-colors duration-300 ${darkMode ? 'bg-gray-900' : 'bg-gradient-to-br from-gray-50 to-gray-100'
        }`}>
