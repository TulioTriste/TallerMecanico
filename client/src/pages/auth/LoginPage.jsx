      ...
      >
        <div className="w-full max-w-md mx-auto">
          ...
          >
            ...
            <div className="mb-6">
              <label
                className={`block text-sm font-medium mb-3 text-center ${darkMode ? "text-gray-300" : "text-gray-700"}`}
              >
                Selecciona tu tipo de usuario
              </label>
              <div
                className={`flex items-center justify-center p-1 rounded-lg ${darkMode ? "bg-gray-700" : "bg-gray-100"}`}
              >
                <button
                  type="button"
